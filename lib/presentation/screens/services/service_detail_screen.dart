...
class ServiceDetailScreen extends GetView<ServicesController> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.currentServiceDetail.value = initialService;

      controller.fetchServiceDetail(initialService.id, isBackgroundFetch: true);
    });
    return Obx(() {
      final ServiceEntity? service = controller.currentServiceDetail.value;
            ...
            children: [
              ...
              Expanded(
                child: CustomButton(
                  ...
                  color:
                      service.availability ? theme.colorScheme.primary : null,
                ),
              ),
            ],
          ),
